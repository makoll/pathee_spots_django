...
class Spot(models.Model):
    ...
    lat = models.DecimalField(
        '緯度', max_digits=8, decimal_places=6, default=None, blank=True, validators=[validate_lat],
    )
    lng = models.DecimalField(
        '経度', max_digits=9, decimal_places=6, default=None, blank=True, validators=[validate_lng],
    )
    ...
    phone = models.CharField(max_length=255, default=None, blank=True, validators=[validate_phone])
